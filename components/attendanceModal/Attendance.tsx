...
export default function AttendanceModal({date,id,status}){
    ...
    return (
      ...
      {confiramtionData && (
        <div>{confiramtionData.data.employeeId.firstName} Have Been Successfully checked in </div>
      )}
      {error && (
        <h3>{error}</h3>
      )}
